...
new_familiar <- ifelse(data$score<3, "NF", ifelse(data$score>3, "F", "NONE"))
data$familiar_n <- new_familiar
data$familiar_n <- as.factor(data$familiar_n)

str(data) 

data = data[data$familiar_n== "NF" | data$familiar_n=="F", ]
...
## with newly defined familiar group division (1,2,3 = NF, 4,5 = F)

# Overall brainwave comparison (Total section Average)
var.test(channel_data$RA_T, channel_data$RA_T)
t.test(data = channel_data, RA_T ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RB_T ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RT_T ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RG_T ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RSMR ~ familiar_n, var.equal=TRUE)


# Part 1: section 1, section 2, section 3
var.test(channel_data$RA_part1_, channel_data$RA_part1_)
t.test(data = channel_data, RA_part1_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RB_part1_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RT_part1_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RG_part1_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RSMR_part1_ ~ familiar_n, var.equal=TRUE)


# Part 2: section 4, section 5, section 6
var.test(channel_data$RA_part2_, channel_data$RA_part2_)
t.test(data = channel_data, RA_part2_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RB_part2_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RT_part2_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RG_part2_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RSMR_part2_ ~ familiar_n, var.equal=TRUE)


# Part 3: section 7
var.test(channel_data$RA_part3_, channel_data$RA_part3_)
t.test(data = channel_data, RA_part3_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RB_part3_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RT_part3_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RG_part3_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RSMR_part3_ ~ familiar_n, var.equal=TRUE)


# Part 4: section 8, section 9, section 10
var.test(channel_data$RA_part4_, channel_data$RA_part4_)
t.test(data = channel_data, RA_part4_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RB_part4_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RT_part4_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RG_part4_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RSMR_part4_ ~ familiar_n, var.equal=TRUE)


# Part 5: section 11, section 12
var.test(channel_data$RA_part5_, channel_data$RA_part5_)
t.test(data = channel_data, RA_part5_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RB_part5_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RT_part5_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RG_part5_ ~ familiar_n, var.equal=TRUE)
t.test(data = channel_data, RSMR_part5_ ~ familiar_n, var.equal=TRUE)
...
result_eeg <-aov(RSMR ~ familiar_n, data = data)
anova(result_eeg)


## Two-way ANOVA test for both variables
result_both <- aov(RA_T ~ channel + familiar_n, data = data)
anova(result_both)
